...
.dropdown-menu{
  ...
  <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBqGAl9YgkfajsynEgfhrFujGY-QNZUs6k">
</script>
<script>
  var map;
  var geoJSON;
  ...
  var openWeatherMapKey = "a9e36dc51bdeb4a5e4a07ef28cd9d5d6"
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="4DaysHistory.jsp">4 days History</a></li>
